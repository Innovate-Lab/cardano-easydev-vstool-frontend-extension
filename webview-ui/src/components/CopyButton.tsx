...
export const CopyButton = () => {
    return (
        <button className="w-[32px] h-[32px] cursor-pointer shrink-0" title="Copy private key">
            <div className="w-full h-full bg-[rgba(92,92,92,0.27)] rounded-full flex items-center justify-center border border-[rgba(255,255,255,0.21)] hover:bg-[rgba(92,92,92,0.4)] transition-colors">
